...
class AverageMeter:
    ...
    Useful for tracking metrics like loss over multiple batches.
    """
...
class MetricLogger:
    ...
    Paper Context:
    Tracks training loss, reconstruction loss, contrastive loss,
    learning rate, etc. over the 600K training iterations.
    """
