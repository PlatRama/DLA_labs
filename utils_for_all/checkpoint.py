...
class CheckpointManager:
    ...
    Paper Context:
    The paper saves checkpoints every 10,000 iterations and keeps
    the best 5 based on validation loss. This allows resuming training
    and selecting the best model for downstream tasks.
    """
